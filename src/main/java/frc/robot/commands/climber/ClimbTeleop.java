...
public class ClimbTeleop extends Command {
    ...
    public ClimbTeleop(ClimberSubsystem cSubsystem, DoubleSupplier climbSpeedSupplier) {
        this.subsystem = cSubsystem;
    ...
    @Override
    public void execute() {
        this.subsystem.manualClimb(this.climbSpeedSupplier.getAsDouble());
    }
