...
public final class Autos {
     ...
     * We assume that it is already correctly aimed and as such we don't attempt to turn the robot
    ...
    /**
     * This is a command that will lower the intake in preperation for another command such as RunIntake
     * @param intake The intake subsystem, we are directly controlling it, so this command will cancel other commands that control it
     * @return A command object, in our case usually used to create named commands
     */
    ...
    /**
     * This is an endless command that will intake a note, use this in a parallel race group
     * @param intake The intake subsystem, we are directly controlling it, so this command will cancel other commands that control it
     * @return A command object, in our case usually used to create named commands
     */
    ...
    /**
     * This is a command that will Raise the intake in preperation for another command such as Shoot
     * @param intake The intake subsystem, we are directly controlling it, so this command will cancel other commands that control it
     * @return A command object, in our case usually used to create named commands
     */
    public static Command raiseIntake(IntakeSubsystem intake) {
        return new RaiseIntake(intake);
    }
